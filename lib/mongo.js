...
function initialize(params) {
    ...
    function extend(attributes) {
        ...
        function saveData(context, input) {
            var obj = CommonHelper.deleteAllPropertiesWhichAreUndefined(context.getDBObject(input));
            if(obj._id) {
            ...
            return new Promise(function(resolve, reject) {
                getClient(server, pools, function(err, client) {
                    ...
                    if (config) {
                        ...
                        {
                            $set : CommonHelper.deleteAllPropertiesWhichAreUndefined(self.getDBObject(set_fields))
